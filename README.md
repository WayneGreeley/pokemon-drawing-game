...
A Halloween-themed web application where you draw a Pokémon and AI tries to guess what you drew! Built for the Kiroween contest.
...
- 👻 Spooky Halloween theme with Ghost-type Pokémon
...
This project is an entry for the Kiroween contest. The `.kiro/` directory contains the complete development specification and must remain in the repository.
